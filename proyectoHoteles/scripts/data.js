...
const hotelsData = [
  {
    ...
    dateFrom: today.valueOf(),
    dateTo: today.valueOf() + 864000000, // 10 days
    rooms: 11,
    city: 'Buenos Aires',
    country: 'Argentina',
    price: 4
  },
  {
    ...
    dateFrom: today.valueOf() + 864000000, // 10 days
    dateTo: today.valueOf() + 1296000000, // 15 days
    rooms: 23,
    city: 'Mar del Plata',
    country: 'Uruguay',
    price: 2
...
//     dateFrom: today.valueOf() + 432000000, // 5 days
//     dateTo: today.valueOf() + 1296000000, // 15 days
//     rooms: 16,
//     city: 'Mendoza',
//     country: 'Argentina',
...
//     dateFrom: today.valueOf() + 1728000000, // 20 days
//     dateTo: today.valueOf() + 2592000000, // 30 days
//     rooms: 32,
//     city: 'Jujuy',
//     country: 'Argentina',
//     price: 1
...
//   //   dateFrom: today.valueOf(),
//   //   dateTo: today.valueOf() + 432000000, // 5 days
//   //   rooms: 14,
//   //   city: 'Salta',
//   //   country: 'Argentina',
//   //   price: 2
...
//   //   dateFrom: today.valueOf() + 1296000000, // 15 days 
//   //   dateTo: today.valueOf() + 2592000000, // 30 days
//   //   rooms: 16,
//   //   city: 'Córdoba',
//   //   country: 'Argentina',
...
//     dateFrom: today.valueOf() + 2592000000, // 30 days
//     dateTo: today.valueOf() + 3456000000, // 40 days
//     rooms: 40,
...
//     dateFrom: today.valueOf() + 864000000, // 10 days
//     dateTo: today.valueOf() + 1728000000, // 20 days
//     rooms: 21,
//     city: 'Pucón',
//     country: 'Chile',
//     price: 4
...
//     dateFrom: today.valueOf() + 2160000000, // 25 days
//     dateTo: today.valueOf() + 2592000000, // 30 days
//     rooms: 4,
//     city: 'Colonia',
//     country: 'Uruguay',
